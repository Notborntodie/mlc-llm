...
# Get a response using a prompt without streaming
payload = {
    "model": "./dist/Llama-2-7b-chat-hf",
    #"model": "./dist/Llama-2-7b-chat-hf-q0f16",
...
prefill_speed = response["prefill_speed"] # expected None
print(f"Logprobs: {log_probes}; Is_greedy: {is_greedy} Prefill_speed: {prefill_speed} tokens/sec")
